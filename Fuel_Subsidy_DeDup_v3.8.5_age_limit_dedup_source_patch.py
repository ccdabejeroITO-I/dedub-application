# -*- coding: utf-8 -*-
"""
Fuel_Subsidy_DeDup_v3.8.5 Streamlit wrapper
Single-file build generated from the user's uploaded Tkinter app.

Run:
    streamlit run Fuel_Subsidy_DeDup_v3.8.5_streamlit_singlefile.py
"""
...
def _build_prefix_and_tag(file_a_name: str, file_b_name: str):
    ...
    if base_a:
        return base_a, "Aonly"
    return base_b or "Fuel_Subsidy", "Bonly"
...
def main():
    st.set_page_config(page_title="Fuel Subsidy DeDup Streamlit", layout="wide")
    st.title("Fuel_Subsidy_DeDup v3.8.5 — Streamlit")
    ...
    with opt4:
        if app_mode == "Preset":
            st.info("Preset mode keeps the built-in Fuel Subsidy behavior, but you can still adjust each detected header before running.")
        else:
    ...
    if st.session_state.get("fuel_export_zip_bytes"):
        st.download_button(
            ...
            file_name=st.session_state.get("fuel_export_zip_name", "Fuel_Subsidy_Export.zip"),
